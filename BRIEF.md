...
### M2 — Full content + SVG extrusion (PARTIAL — see status log)
...
- [ ] Preset system (`Preset` wrapper type, versioned) + curated preset gallery. —
      NOT in this pass; out of the dispatched scope, still open.
- [ ] "Surprise me" coherent-random-combo button. — NOT in this pass; out of the
      dispatched scope, still open.
...
## Status
**M0 and M1 complete — M2 partial (content expansion + SVG extrusion done; presets
and "Surprise me" still open).**
